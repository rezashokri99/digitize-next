    ...
    return (
        <div className="w-full">
            ...
            <div className={`${showCollapseModal ? "translate-y-0" : "translate-y-full"} duration-300 w-full fixed bottom-0 left-0 z-20 py-6 px-5 bg-white rounded-t-3xl min-h-[500px] max-h-[calc(100vh_-_20px)] overflow-y-scroll shadow-[0_-4px_12px_rgba(0,0,0,0.1)]`}>
                <h4 className="font-bold text-xl text-orange-500 mb-1 pr-3">فیلتر</h4>
                ...
                <div className="flex w-full py-3 px-3 mb-20">
                    <div className="relative w-5 h-5 bg-slate-200 rounded-full mb-1 ml-2">
                ...
                <div className="px-4 flex gap-x-4 mb-4 fixed bottom-0 left-0 w-full">
                    <button className="w-full py-2 rounded bg-orange-500 text-white">
                        اعمال فیلتر
                    </button>
                    <button onClick={() => setShowCollapseModal(false)} className="w-full py-2 font-bold rounded bg-red-100 text-orange-600 border-2 border-orange-500">
                        لغو فیلتر
                    </button>
                </div>
            </div>
